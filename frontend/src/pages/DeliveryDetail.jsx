    ...
    <DashboardLayout>
      <div className="p-8">
        ...
        <div className="mb-6 flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" onClick={() => navigate("/operations?tab=delivery")}>
            Cancel
          </Button>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                <div className="space-y-2">
                  ...
                  <Input placeholder="Enter delivery address" className="border-b border-t-0 border-x-0 rounded-none px-0" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center border-b pb-2">
                    <Input defaultValue="Delivery" disabled className="border-0 px-0 bg-transparent" />
                  </div>
                </div>
              </div>
            </CardContent>
